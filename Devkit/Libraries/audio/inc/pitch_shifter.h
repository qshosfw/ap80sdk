 ...
 */
int32_t init_pitch_shifter(PSContext *ct, int32_t num_channels, int32_t sample_rate, int32_t semitone_steps, int32_t w);
 ...
 * @param semitone_steps Number of steps to change in unit of 0.1 semitone. Range: LOWER_SEMITONE_LIMIT ~ UPPER_SEMITONE_LIMIT
 */
int32_t configure_pitch_shifter(PSContext *ct, int32_t semitone_steps);
 ...
 * @return error code. PS_ERROR_OK means successful, other codes indicate error.
 */
int32_t apply_pitch_shifter(PSContext *ct, int16_t *pcm_in, int16_t *pcm_out);
