...
/**
 * @brief  restore din or do to general IO
 * @param  ModeSel: config I2S pins multiplex relation,valid para 0,1,2,0xFF
 *		 0:
 *		    i2s_din(i)     b[6]
 *		    i2s_do(o)      b[5]
 ...
 *		    i2s_din(i)     c[12]
 *		    i2s_do(o)      c[11]
 *     0xFF:restore all the pins used for Pcm Sync to general IO
 *       IsDo: 1: restore Do to general IO
 *             0: restore Din to general IO
 * @return None
 */
void GpioI2sDoDinRestoreIo(uint8_t ModeSel, bool IsDo);
 ...
 * 					A0_FOR_CHARGER
 * 					A0_FOR_PWM
 * @return  When A0 need to be used as GPIO(non-PULLDOWN), set A0_FOR_GPIO mode
