...
/**
 * @brief WakeUp Flag.
 * @ wakeup flag from DeepSleep
 * @ WAKEUP_FLAG_POR_LDOIN is power on flag
 * @ WAKEUP_FLAG_POR_RTC, WAKEUP_FLAG_POR_POWERKEY, WAKEUP_FLAG_POR_8SRST, WAKEUP_FLAG_POR_POWER
 * @ these four flags are detail flag for WAKEUP_FLAG_POR_LDOIN
 */

#define WAKEUP_FLAG_POR_LDOIN		0x00001		/**<power on*/
#define WAKEUP_FLAG_WDG				0x00002
#define WAKEUP_FLAG_RTC				0x00004		/**<RTC Alarm WakeUp*/
#define WAKEUP_FLAG_POWERKEY		0x00008		/**<POWER-KEY WakeUp*/
#define WAKEUP_FLAG_SYSRST			0x00010		/**<System Reset*/ 
...
#define WAKEUP_FLAG_POR_RTC			0x040000		/**<RTC Alarm WakeUp Core*/ 
#define WAKEUP_FLAG_POR_POWERKEY	0x080000		/**<POWER-KEY PowerOn system*/ 
#define WAKEUP_FLAG_POR_8SRST		0x100000		/**<POWER-KEY 8S Reset*/
#define WAKEUP_FLAG_POR_POWER		0x200000		/**<DC IN with POWER key ON*/ 

/**
 * @brief WakeUp Source(in deep Sleep mode) Select.
 */
...
/**
 * @brief WakeUp Source(in power-down) Select.
 */
#define WAKEUP_SRC_PD_POWERKEY		0x2000
#define WAKEUP_SRC_PD_RTC			0x4000

/**
 * @brief Pin(GPIO、POWER-KEY WakeUp) wakeUp Trig Polarity(1'b0: low wakeup, 1'b1: high wakeup).
 */
...
/**
 * @brief Pin(GPIO、POWER-KEY) wakeup minimal time mode(0: no minimal time limitation, 1: minimal time is 1ms).
 */
#define WAKEUP_TMODE_0MS			0
#define WAKEUP_TMODE_1MS			1

/**
 * @brief POWER-KEY mode.
 */
#define POWERKEY_MODE_BYPASS				0
#define POWERKEY_MODE_PUSH_BUTTON		1	  
#define POWERKEY_MODE_SLIDE_SWITCH	2	


/**
 * @brief Global wakeup flag.
 */
 ...
 *		   c). After this function is used,the wakeup-flag is cleard.
 */
