 ...
 */
int32_t init_drc(DRCContext *ct, int32_t num_channels, int32_t sample_rate, int32_t fc, int32_t order, int32_t threshold[2], int32_t ratio[2], int32_t attack_tc[2], int32_t release_tc[2]);
 ...
 * @return error code. DRC_ERROR_OK means successful, other codes indicate error.
 */
int32_t apply_drc(DRCContext *ct, int16_t *pcm_in, int16_t *pcm_out, int32_t n, int32_t pregain);
