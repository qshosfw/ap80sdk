...
//CONSTDATA DCD 0x6B000
CONSTDATA	DCD    0x80000	//---8MBIT

	//user data offset
	AREA    |.ARM.__at_0x00000090|, CODE, READONLY
//USERDATA	DCD 0x1A0000
//USERDATA	DCD 0x6B000
USERDATA	DCD    0xEB000	//蓝牙现在只用44K---8MBIT

	//sdk version
	AREA    |.ARM.__at_0x00000094|, CODE, READONLY
SDK_VER_CHIPID	DCB		0x12    //MV chip ID
SDK_VER_MAJOR	DCB		1       //MV SDK major version
SDK_VER_MINOR	DCB		5      //MV SDK minor version
SDK_VER_USER	DCB		162//user SDK version
