...
//0x1A0000 ~ 0x1A0000+64K 为蓝牙所用
//0x1A0000+64k ~ 0x1A0000+64K+16K 为Breakpoint 所用
//示例代码中Flash 写/擦除的操作地址从 0x1A0000+64K+16K = 0x1B4000 开始
...
{	
	...
	SysPowerKeyInit(POWERKEY_MODE_SLIDE_SWITCH, 500);	//硬开关模式
#endif
