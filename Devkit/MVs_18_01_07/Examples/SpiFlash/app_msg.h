...
{	
	...
	MSG_BT_STATE_A2DP_READY, 	// a2dp状态：连接就绪
	MSG_BT_STATE_A2DP_UNREADY,	// a2dp状态：连接断开

	MSG_BT_STATE_SPP_READY,		// spp状态：连接就绪
	MSG_BT_STATE_SPP_UNREADY,	// spp状态：连接断开

	MSG_BT_STATE_HF_READY,		// HF状态：连接就绪
	MSG_BT_STATE_HF_UNREADY,		// HF状态：连接断开
};
