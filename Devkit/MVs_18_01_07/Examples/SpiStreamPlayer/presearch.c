...
extern bool CheckAllDiskLinkFlag(void);
...
//	uint32_t i;
//	NVM_PLAYER_INFO NvmPlayInfo;
//	BP_LoadPlayerInfo(&NvmPlayInfo);

//	for(i = 0; i < PLAYER_DISK_BP_CNT && i < BPCnt; i++)
//	{
//		PlayerBPInfo[i].FileAddr = NvmPlayInfo.PlayDiskInfo[i].FileAddr;
//		PlayerBPInfo[i].CRC8     = NvmPlayInfo.PlayDiskInfo[i].CRC8;
//	}
