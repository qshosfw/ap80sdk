/**
 **************************************************************************************
 * @file    audio_encoders_test_without_os.c
 * @brief   Audio Encoders Testbench Without OS
 * 
 * @author  Aissen Li
 * @version V1.0.0
 * 
...
int32_t main(void)
{
    ...
    WaitMs(100);
    DBG("/==========================================================================\\\n");
    DBG("|              AUDIO CODEC (ENCODERS) TESTBENCH WITHOUT OS                 |\n");
    ...
    //Init timer1 interrupt for audio encoder.
