 ...
 *   The File is Auto Generated by ACPWorkbench V7.2.2
 *              Firmware Version: CODEC 7.2.2
 *                All Right Reserved
 *******************************************************/
...
#define AUDIO_EFFECT_PARAM_ECHO_DELAY          ( 8820)  //200 ms
...
#define AUDIO_EFFECT_PARAM_DRC_PREGAIN         ( 4096)  //Pregain: 0.00dB
#define AUDIO_EFFECT_PARAM_DRC_CROSSOVER_FREQ  (  300)  //unit in Hz
#define AUDIO_EFFECT_PARAM_DRC_THRESHHOLD1     (-3975)  //-39.75dB
#define AUDIO_EFFECT_PARAM_DRC_RATIO1          (    2)  //2:1
#define AUDIO_EFFECT_PARAM_DRC_ATTACK_TIME1    (   10)  //unit in ms
#define AUDIO_EFFECT_PARAM_DRC_RELEASE_TIME1   (   60)  //unit in ms
#define AUDIO_EFFECT_PARAM_DRC_THRESHHOLD2     (-5000)  //-50dB
#define AUDIO_EFFECT_PARAM_DRC_RATIO2          (    3)  //3:1
#define AUDIO_EFFECT_PARAM_DRC_ATTACK_TIME2    (   10)  //unit in ms
#define AUDIO_EFFECT_PARAM_DRC_RELEASE_TIME2   (   60)  //unit in ms
